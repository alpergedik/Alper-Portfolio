...
Phase 1: real portfolio data. The final Professional Mode, Engineer Mode, and protected admin dashboard are intentionally not implemented yet.
...
See `docs/architecture.md` for the Phase 1 structure and expansion notes.
